          ...
          <table>
            ...
            <tr class="jiesuan">
              <td colspan="5" class="jiesuan_a">
                <div class="jiesuan_z">
                    <div class="jiesuan_b">
                  <div v-if="checkAll===false"><Checkbox v-model="checkAll" @click="checkedAll">全选</Checkbox></div>
                  <div v-else-if="checkAll===true"><Checkbox v-model="checkAll" @click="checkedAll">取消全选</Checkbox></div>
                  <div class="jiesuan_c">删除选中商品</div>
                </div>
                <div class="jiesuan_d">
                  <div class="jiesuan_e">
                    <div>
