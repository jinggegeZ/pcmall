        ...
        <div class="goods_a">
          <div class="gleft">
            <div class="glimg" v-for="(item,index) in list" :key="index">
              <div @click="getIndex(img.url)" class="ggimg">
                <img :src="item" alt width="75px" />
              </div>
            </div>
          </div>
          <div class="gright">
            <img :src="ImgUrl" alt width="350px" />
          </div>
        </div>
        <!-- 操作 -->
        <div class="stuff">
...
export default {
  data() {
    return {
      ...
      ids: "",
      imgurl: [
        { index: 0, url: require(index[0]) },
        { index: 1, url: require(index[1]) },
        { index: 2, url: require(index[2]) },
        { index: 3, url: require(index[3]) },
        { index: 4, url: require(index[4]) },
      ]
    };
  },
  components: {},
