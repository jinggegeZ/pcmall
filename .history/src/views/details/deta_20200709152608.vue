      ...
      <div class="goods">
        ...
        <div class="goods_a">
          <div class="gleft" >
            ...
            <div @click='getIndex(img.url)' class="ggimg" ><img :src="item" alt="" width="75px"></div>
            </div>
          </div>
          <div class="gright"><img :src="ImgUrl" alt="" width="350px"></div>
        </div>
        <!-- 操作 -->
        <div class="stuff">
          <div class="stuff_1">
...
export default {
  data() {
    return {
      ...
      ids:'',
      imgUrl: [
                { index:0, url: require('./img/goods1.png') },
                { index:1, url: require('./img/goods2.png') },
                { index:2, url: require('./img/goods3.png') },
                { index:3, url: require('./img/goods4.png') },
                { index:4, url: require('./img/goods5.png') },
            ]
  },
  components: {},
  methods: {
